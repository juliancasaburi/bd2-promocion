...
public interface JPAAccidentTerrainDataRepository extends JpaRepository<AccidentTerrainData, Long> {
     ...
     *         crossing
     */
    @Query("select atd.crossing as value, count(atd) as count \n" +
     ...
     *         giveWay
     */
    @Query("select atd.giveWay as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
     ...
     *         junction
     */
    @Query("select atd.junction as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
     ...
     *         noExit
     */
    @Query("select atd.noExit as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
            "group by atd.noExit \n" +
     ...
     *         railway
     */
    @Query("select atd.railway as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
     ...
     *         stop
     */
    @Query("select atd.stop as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
            "group by atd.stop \n" +
     ...
     *         turningLoop
     */
    @Query("select atd.turningLoop as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
     ...
     *         station
     */
    @Query("select atd.station as value, count(atd) as count \n" +
            "from AccidentTerrainData atd \n" +
