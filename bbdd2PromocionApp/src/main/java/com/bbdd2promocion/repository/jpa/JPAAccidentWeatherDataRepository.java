...
public interface JPAAccidentWeatherDataRepository extends JpaRepository<AccidentWeatherData, Long> {
   ...
   */
  @Query(
      "select awd.weatherCondition as value, count(awd) as count \n"
   ...
   */
  @Query(
      "select awd.visibility as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
   ...
   */
  @Query(
      "select awd.windChill as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
   ...
   */
  @Query(
      "select awd.windDirection as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
   ...
   */
  @Query(
      "select awd.windSpeed as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
   ...
   */
  @Query(
      "select awd.pressure as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
   ...
   */
  @Query(
      "select awd.humidity as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
   ...
   */
  @Query(
      "select awd.temperature as value, count(awd) as count \n"
          + "from AccidentWeatherData awd \n"
