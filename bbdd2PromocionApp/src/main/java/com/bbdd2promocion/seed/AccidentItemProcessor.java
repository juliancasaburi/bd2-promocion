...
public class AccidentItemProcessor implements ItemProcessor<AccidentDTO, Accident> {
  ...
  public Accident process(AccidentDTO data) throws Exception {
    ...
    accidentLocationData.setStartLocation(
        new GeoJsonPoint(
            Double.parseDouble(data.getStartLng()), Double.parseDouble(data.getStartLat())));
    ...
    accidentLocationData.setPoint(
        GeometryUtil.parseLocation(
            Double.parseDouble(accidentLocationData.getStartLng()),
            Double.parseDouble(accidentLocationData.getStartLat())));
