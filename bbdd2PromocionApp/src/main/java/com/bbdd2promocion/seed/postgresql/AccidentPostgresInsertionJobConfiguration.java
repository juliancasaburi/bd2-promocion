...
public class AccidentPostgresInsertionJobConfiguration {
  ...
  public AccidentPostgresInsertionJobConfiguration(
  ...
  public Step accidentPostgresStep(
      @Qualifier("asyncTaskExecutorPostgres") TaskExecutor taskExecutor,
      FlatFileItemReader<AccidentDTO> accidentFlatFileItemReader,
      @Qualifier("accidentHibernateItemWriter")
          HibernateItemWriter<Accident> accidentHibernateItemWriter,
  ...
  public TaskExecutor taskExecutor() {
    SimpleAsyncTaskExecutor taskExecutor =
        new SimpleAsyncTaskExecutor("spring_batch_accident_postgres");
  ...
  public Job accidentPostgresInsertionJob(@Qualifier("accidentPostgresStep") Step step) {
    return this.jobBuilderFactory
        .get("accidentPostgresInsertionJob")
