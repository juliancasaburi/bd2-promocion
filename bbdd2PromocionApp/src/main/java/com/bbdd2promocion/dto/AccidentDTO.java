...
public class AccidentDTO {
    ...
    public String toString() {
        return "Accident{" + "id='" + csvId + '\'' + ", source='" + source + '\'' + ", tmc='" + tmc + '\'' + ", severity=" + severity + ", startTime=" + startTime + ", endTime=" + endTime + ", startLat='" + startLat + '\'' + ", startLng='" + startLng + '\'' + ", endLat='" + endLat + '\'' + ", endLng='" + endLng + '\'' + ", distance=" + distance + ", description='" + description + '\'' + ", number='" + number + '\'' + ", street='" + street + '\'' + ", side='" + side + '\'' + ", city='" + city + '\'' + ", county='" + county + '\'' + ", state='" + state + '\'' + ", zipcode='" + zipcode + '\'' + ", country='" + country + '\'' + ", timezone='" + timezone + '\'' + ", airportCode='" + airportCode + '\'' + ", weatherTimestamp=" + weatherTimestamp + ", temperature=" + temperature + ", windChill=" + windChill + ", humidity=" + humidity + ", pressure=" + pressure + ", visibility=" + visibility + ", windDirection='" + windDirection + '\'' + ", windSpeed=" + windSpeed + ", precipitation=" + precipitation + ", weatherCondition='" + weatherCondition + '\'' + ", amenity=" + amenity + ", bump=" + bump + ", crossing=" + crossing + ", giveWay=" + giveWay + ", junction=" + junction + ", noExit=" + noExit + ", railway=" + railway + ", roundabout=" + roundabout + ", station=" + station + ", stop=" + stop + ", trafficCalming=" + trafficCalming + ", trafficSignal=" + trafficSignal + ", turningLoop=" + turningLoop + ", sunriseSunset='" + sunriseSunset + '\'' + ", civilTwilight='" + civilTwilight + '\'' + ", NauticalTwilight='" + nauticalTwilight + '\'' + ", AstronomicalTwilight='" + astronomicalTwilight + '\'' + '}';
    }
}
