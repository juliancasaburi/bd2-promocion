...
/** Esta clase contiene la implementación de los servicios relacionados con los TestModel. */
@Service
@Transactional
public class TestModelServiceImpl implements ITestModelService {

  /** Es el repositorio ligado a los TestModel. */
  @Inject private JPATestModelRepository testModelPostgresRepository;

  @Inject private MongoTestModelRepository testModelMongoRepository;
